...
Walkthrough for [`M62-plan.md`](M62-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (spit stations, Store wear, rack/wrap/tile/pie). Next slice: [`M63-plan.md`](M63-plan.md).
