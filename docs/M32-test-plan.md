...
Walkthrough for [`M32-plan.md`](M32-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (kin_of incentives, household, aging). Next slice: [`M58-plan.md`](M58-plan.md).
