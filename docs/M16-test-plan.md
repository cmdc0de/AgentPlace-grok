...
Walkthrough for [`M16-plan.md`](M16-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (board accept vs open, `/set`). Next slice: [`M26-plan.md`](M26-plan.md).
