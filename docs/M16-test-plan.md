...
Walkthrough for [`M16-plan.md`](M16-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (board accept vs open, `/set`). Next slice: [`M32-plan.md`](M32-plan.md).
