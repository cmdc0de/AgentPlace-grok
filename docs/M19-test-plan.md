...
Walkthrough for [`M19-plan.md`](M19-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (SetCouncilTally, `/set respect`, Backpack, crate scale). Next slice: [`M26-plan.md`](M26-plan.md).
