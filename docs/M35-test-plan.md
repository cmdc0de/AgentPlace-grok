...
Walkthrough for [`M35-plan.md`](M35-plan.md). Automated tests prove the slice; the `sim-cli` / viewer / browser steps below are what you **read** (inventions, postcard WS page). Next slice: [`M52-plan.md`](M52-plan.md).
