...
Walkthrough for [`M34-plan.md`](M34-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (sheet effects, close-kin PairBond). Next slice: [`M59-plan.md`](M59-plan.md).
