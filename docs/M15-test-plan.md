...
Walkthrough for [`M15-plan.md`](M15-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (board accept vs open). Next slice: [`M46-plan.md`](M46-plan.md).
