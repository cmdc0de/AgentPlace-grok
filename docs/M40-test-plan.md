...
Walkthrough for [`M40-plan.md`](M40-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (config-owned objects + recipes, optimized glb paths). Next slice: [`M47-plan.md`](M47-plan.md).
