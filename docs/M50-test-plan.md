...
Walkthrough for [`M50-plan.md`](M50-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (FPS HUD, sqlite columns, extra recipes). Next slice: [`M63-plan.md`](M63-plan.md).
