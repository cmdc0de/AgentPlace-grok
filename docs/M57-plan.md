...
| `--no-time` shipped objects 2 ticks | hash ≠ M56 `6d2df92b…` (lock on implement) |
| default CLI 2 ticks (time on) | hash ≠ M56 `34f16591…` (document) |
...
Walkthrough: `docs/M57-test-plan.md` (written on implement).
