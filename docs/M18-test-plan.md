...
Walkthrough for [`M18-plan.md`](M18-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (council tally, SetCouncil, `/scrub` catch-up). Next slice: [`M47-plan.md`](M47-plan.md).
