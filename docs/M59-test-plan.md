...
Walkthrough for [`M59-plan.md`](M59-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (CraftBonus/RestBonus, per-instance wear, raft/sandals/mortar/jerky). Next slice: [`M61-plan.md`](M61-plan.md).
