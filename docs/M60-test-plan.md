...
Walkthrough for [`M60-plan.md`](M60-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (Transfer wear, CPU percent, stool/sash/brick/biscuit). Next slice: [`M61-plan.md`](M61-plan.md).
