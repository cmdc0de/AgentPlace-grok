...
Walkthrough for [`M14-plan.md`](M14-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (coalition overlay, `--load DIR` scrubber). Next slice: [`M17-plan.md`](M17-plan.md).
