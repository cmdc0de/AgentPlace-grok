...
Walkthrough for [`M52-plan.md`](M52-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (day/night clock, `--width`/`--height`, OTLP/JSON). Next slice: [`M58-plan.md`](M58-plan.md).
