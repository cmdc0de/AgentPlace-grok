...
Walkthrough for [`M11-plan.md`](M11-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (events JSONL, `--compare`, satchel, `/give basket`). Next slice: [`M22-plan.md`](M22-plan.md).
