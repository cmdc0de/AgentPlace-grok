...
Walkthrough for [`M56-plan.md`](M56-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (axe gather bonus, Draco decode, fence/mat/snare/spit). Next slice: [`M62-plan.md`](M62-plan.md).
