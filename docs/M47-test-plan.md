...
Walkthrough for [`M47-plan.md`](M47-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (camera pan, missing-asset sentinel, time-series charts). Next slice: [`M60-plan.md`](M60-plan.md).
