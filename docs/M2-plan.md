...
M3–M38 are done. **Current next slice:** [`M39-plan.md`](M39-plan.md) (object definition files: visual + LOD + hashed catalog). Later work is listed at the bottom of that file.
