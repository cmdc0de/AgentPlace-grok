...
M3–M27 are done. **Current next slice:** [`M28-plan.md`](M28-plan.md) (health/incapacitation, combat viewer FX, force_reflect). Later work is listed at the bottom of that file.
