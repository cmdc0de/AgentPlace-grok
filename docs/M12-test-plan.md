...
Walkthrough for [`M12-plan.md`](M12-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (Observation vs inspector, `--compare`, prompt). Next slice: [`M14-plan.md`](M14-plan.md).
