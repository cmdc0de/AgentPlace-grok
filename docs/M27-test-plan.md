...
Walkthrough for [`M27-plan.md`](M27-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (auto-execute plan, combat). Next slice: [`M57-plan.md`](M57-plan.md).
