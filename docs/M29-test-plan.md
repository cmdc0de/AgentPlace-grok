...
Walkthrough for [`M29-plan.md`](M29-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (local embeddings, combat death, CI Win/mac). Next slice: [`M43-plan.md`](M43-plan.md).
