...
> “Here are the design specifications and milestone plans. Read `00-INDEX-AND-HANDOFF.md` first (progress table). M27 is implemented; later work is listed at the bottom of `M27-plan.md`. Do not expand into items it defers (protobuf/TLS).”
...
M1–M27 are done (tag `M27`). Later work is listed at the bottom of [`M27-plan.md`](M27-plan.md).

```
Read docs/00-INDEX-AND-HANDOFF.md, then docs/M27-plan.md.
M27 is implemented (auto-execute plan; combat v2-lite;
