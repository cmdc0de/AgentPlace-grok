...
| **M61** | Planned — next | [`M61-plan.md`](M61-plan.md) | Time-decay wear, out-dir disk walk, extra recipes |
...
| 66 | `M61-plan.md` | Milestone 61 (planned): time-decay wear, out-dir disk walk, extra recipes |
...
> “Here are the design specifications and milestone plans. Read `00-INDEX-AND-HANDOFF.md` first (progress table). M61 is next (`M61-plan.md`). Do not expand into items it defers (protobuf/TLS, skeletal animation, Bevy in the browser).”
...
M1–M60 are done. Next is M61 ([`M61-plan.md`](M61-plan.md)).

```
Read docs/00-INDEX-AND-HANDOFF.md, then docs/M61-plan.md.
M61 is planned (time-decay wear, out-dir disk walk, extra recipes;
