...
| **M29** | Planned — next | [`M29-plan.md`](M29-plan.md) | Local embeddings, combat death, CI Win/mac |
| After M29 | Not started | listed at the bottom of `M29-plan.md` | protobuf/TLS |
...
| 34 | `M29-plan.md` | Milestone 29 (planned): local embeddings, combat death, CI Win/mac |
...
Upload or attach the specification files **and** the milestone plans (`M2-plan.md` through `M29-plan.md`) plus this `00-INDEX-AND-HANDOFF.md`. Start the conversation with:

> “Here are the design specifications and milestone plans. Read `00-INDEX-AND-HANDOFF.md` first (progress table). M29 is the current slice (`M29-plan.md`). Do not expand into items it defers (protobuf/TLS, browser).”
...
M1–M28 are done. Current slice is [`M29-plan.md`](M29-plan.md) (planned, not yet implemented).

```
Read docs/00-INDEX-AND-HANDOFF.md, then docs/M29-plan.md.
M29 is the current slice (local embeddings; combat death; CI Win/mac;
