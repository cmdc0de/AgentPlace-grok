...
Walkthrough for [`M31-plan.md`](M31-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (kinship, reproduction, D&D-like sheet). Next slice: [`M45-plan.md`](M45-plan.md).
