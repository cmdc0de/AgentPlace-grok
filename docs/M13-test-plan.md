...
Walkthrough for [`M13-plan.md`](M13-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (board accept vs open, `--compare`). Next slice: [`M20-plan.md`](M20-plan.md).
