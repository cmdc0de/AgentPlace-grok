...
Walkthrough for [`M36-plan.md`](M36-plan.md). Automated tests prove the slice; the `sim-cli` / viewer / browser steps below are what you **read** (InspectorView JSON, postcard WS tables). Next slice: [`M49-plan.md`](M49-plan.md).
