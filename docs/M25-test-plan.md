...
Walkthrough for [`M25-plan.md`](M25-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (reflection-on-evict, lockstep Ack timeout). Next slice: [`M43-plan.md`](M43-plan.md).
