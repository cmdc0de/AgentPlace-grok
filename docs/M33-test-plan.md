...
Walkthrough for [`M33-plan.md`](M33-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (household crates, culture, reflect importance). Next slice: [`M46-plan.md`](M46-plan.md).
