...
| PG-11 | OpenTelemetry / performance metrics | Open (M52 JSON POST shipped) | M46 in-process aggregates + RSS. M52: sim-cli OTLP/JSON POST of wall_ns + RSS. Leftover: protobuf/gRPC, CPU/disk, viewer-frame OTLP. |
...
| PG-17 | Sleep places | Done (M53) | Place tent 1×1 / cabin 2×2 / house 4×4; better shelter ⇒ more dawn energy. PG-9 files; rest math is PG-16. |
