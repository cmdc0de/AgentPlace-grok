...
Walkthrough for [`M55-plan.md`](M55-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (ranged DEX to-hit, hoe/net bonuses, rope/needle/bucket/shield). Next slice: [`M61-plan.md`](M61-plan.md).
