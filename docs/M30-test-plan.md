...
Walkthrough for [`M30-plan.md`](M30-plan.md). Automated tests prove the slice; the `sim-cli` / viewer steps below are what you **read** (combat particles / meshes). Next slice: [`M55-plan.md`](M55-plan.md).
