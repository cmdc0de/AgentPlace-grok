...
> **Current slice:** see [`00-INDEX-AND-HANDOFF.md`](00-INDEX-AND-HANDOFF.md) and [`remaining-features.md`](remaining-features.md). Specs are the long-term source of truth; the milestone plan wins on timing.
