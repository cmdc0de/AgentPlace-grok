...
Walkthrough for [`M17-plan.md`](M17-plan.md). Automated tests prove the code; the Spark section is the live LLM proof. CI / `cargo test` never need the network. Next slice: [`M40-plan.md`](M40-plan.md).
