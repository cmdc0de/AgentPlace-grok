...
Walkthrough for [`M17-plan.md`](M17-plan.md). Automated tests prove the code; the Spark section is the live LLM proof. CI / `cargo test` never need the network. Next slice: [`M49-plan.md`](M49-plan.md).
