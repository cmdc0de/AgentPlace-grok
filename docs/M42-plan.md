...
| After M59 | protobuf/TLS/`wss`; Unix sockets; skeletal animation; WIS **board** range; CHA proposal support / pair-bond odds; pocket **weight** cap; wasm32 on Win/mac; sql.js / ad-hoc SQL |
