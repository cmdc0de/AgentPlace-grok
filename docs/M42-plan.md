...
| After M46 | protobuf/TLS/`wss`; Unix sockets; agent meshes; skeletal animation; hot-reload glb; WIS **board** range; CHA proposal support / pair-bond odds; pocket **weight** cap; time-series charts; wasm32 on Win/mac |
