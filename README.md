...
Deterministic multi-agent simulation. Current slice: **M21** (`docs/M21-plan.md`). Walkthrough: [`docs/M21-test-plan.md`](docs/M21-test-plan.md).
...
Incentive A/B (postcard wire `PROTOCOL_VERSION = 3`; `ControlVerb::Scrub` for remote `/scrub`. Timing is not hashed).
